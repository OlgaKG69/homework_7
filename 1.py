...
# в каждой фразе стихотворения одинаковое. Фраза может
# состоять из одного слова, если во фразе несколько
...
st = c.lower()
k = lambda x: sum(1 for i in x if i in 'аеёиоуыэюя')
t = k(st[0])
if all([k(i) == t for i in st]):
    print('Парам пам-пам')
else:
    print('Пам парам')
